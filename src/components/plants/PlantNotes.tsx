      ...
      <div className="flex items-start justify-between mb-2">
        ...
        <div className="flex items-center space-x-1 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
          <button
            onClick={onStartEdit}
            disabled={isUpdating}
            className="p-2 sm:p-1 text-gray-400 hover:text-primary-600 transition-colors disabled:opacity-50"
            title="Edit note"
          >
          ...
          <button
            onClick={onDelete}
            disabled={isUpdating}
            className="p-2 sm:p-1 text-gray-400 hover:text-red-600 transition-colors disabled:opacity-50"
            title="Delete note"
          >
            <svg className="w-4 h-4 sm:w-3 sm:h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
