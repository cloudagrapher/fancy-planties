              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 mt-0.5 text-xs text-neutral-500">
                    ...
                    {plant.daysUntilFertilizerDue !== null && plant.daysUntilFertilizerDue !== undefined ? (
                      <span className={`flex items-center gap-1 ${
                        plant.daysUntilFertilizerDue < 0
                          ? 'text-red-600'
                          : plant.daysUntilFertilizerDue <= 7
                          ? 'text-amber-600'
                          : 'text-neutral-500'
                      }`}>
                        ...
                        {plant.daysUntilFertilizerDue < 0
                          ? `${Math.abs(plant.daysUntilFertilizerDue)}d overdue`
                          : plant.daysUntilFertilizerDue === 0
                          ? 'due today'
                          : `due in ${plant.daysUntilFertilizerDue}d`}
                      </span>
